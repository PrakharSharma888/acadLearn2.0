...
const THEME = {
  ...
  professional: {
    header:      "bg-linear-to-r from-indigo-600 to-violet-600",
    ...
    btnOutline:  "border-indigo-600 text-indigo-600 hover:bg-indigo-50",
    badge:       "Professional",
    successBtn:  "bg-indigo-600 hover:bg-indigo-700",
    successRing: "bg-indigo-50 text-indigo-500",
    dot:         "bg-indigo-500",
